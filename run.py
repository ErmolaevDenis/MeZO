...
def main():
    ...
    if training_args.do_eval:
        ...
        for eval_dataset in eval_datasets:
            ...
            eval_result["time_in_sec"] = int(time.time() - start_time)
            eval_result["memory_in_GB"] = round(torch.cuda.max_memory_allocated() / 1024**3, 2)
    ...
    if training_args.do_predict:
        ...
        for test_dataset in test_datasets:
            ...
            test_result["time_in_sec"] = int(time.time() - start_time)
            test_result["memory_in_GB"] = round(torch.cuda.max_memory_allocated() / 1024**3, 2)
